...
import logo2 from "../assets/socialNation.png";
...
const SignIn = () => {
      ...
      <div className="container mx-auto flex min-h-screen flex-col items-center justify-center px-6">
        <form className="w-full max-w-md">
          <div className="mx-auto flex justify-center">
            <img className="h-10 w-auto sm:h-12 md:h-14 lg:h-16 xl:h-20" src={logo2} alt="" />
        ...
        <span className="flex items-center justify-between py-4 text-sm text-gray-600">
  <a
    href="https://github.com/prashikk"
    target="_blank"
    rel="noopener noreferrer"
    className="flex items-center hover:text-blue-500"
  >
    <AiFillGithub className="mr-1 h-5 w-5" />
    <span className="mr-10 h-5 w-5">GitHub</span>
  </a>

  <a
    href="https://www.linkedin.com/in/praaaashik"
    target="_blank"
    rel="noopener noreferrer"
    className="flex items-center hover:text-blue-500"
  >
    <AiFillLinkedin className="mr-1 h-5 w-5" />
    <span className="mr-10 h-5 w-5" >LinkedIn</span>
  </a>
  ...
  <Link
    ...
    className="flex items-center hover:text-blue-500"
  >
    <MdOutlineAdminPanelSettings className="mr-1 h-5 w-5" />
    <span>Admin</span>
  </Link>
</span>
