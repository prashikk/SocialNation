...
import socialLogo from "../assets/socialNation.png";
...
const SignUpNew = () => {
  ...
  const handleEmailChange = (e) => {
    ...
    if (e.target.value.includes("mod.socialnation.com")) {
      setIsModerator(true);
    } else {
    ...
    <section className="bg-white">
      <div className="container mx-auto flex min-h-screen items-center justify-center px-6">
        <form className="w-full max-w-md" onSubmit={handleSubmit}>
          ...
          <img className="h-10 w-auto sm:h-12 md:h-14 lg:h-16 xl:h-20" src={socialLogo} alt="" />
